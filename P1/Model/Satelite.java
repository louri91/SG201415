...
public class Satelite extends BranchGroup
{
    ...
    // ******* Constructor
    public Satelite (float radio, String textura, float traslacion, long rotacion, double inclinar, Camara camLuna, boolean camara) 
    { 
        ...
        TransformGroup incli = inclinacion(inclinar);
        TransformGroup tras = trasladar(traslacion,0.0f,0.0f);
        TransformGroup rotaAlrededor = rotarAlrededor(rotacion);
        ...
        if(camara)
        {
            tras.addChild(camLuna);
        }
        
        rotaNormal.addChild(fig);
        incli.addChild(rotaNormal);
        tras.addChild(incli);
        rotaAlrededor.addChild(tras);
        this.addChild(rotaAlrededor);
    }
    public BranchGroup getSatelite()
    {
        return this;
    }
    ...
    private TransformGroup inclinacion(double inclinacion)
    {
        TransformGroup incli = new TransformGroup();
        
        Transform3D incli3D = new Transform3D();
        incli3D.rotZ(inclinacion);
